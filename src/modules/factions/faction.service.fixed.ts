import { PrismaClient, Faction, FactionMembership } from '@prisma/client';
...
export class FactionService {
  ...
  async getAllFactions(): Promise<
    (Faction & { members: FactionMembership[] })[]
  > {
    try {

...
export class PlayerService {
  ...
  async registerPlayer(data: RegisterPlayerData): Promise<{
    id: string;
    username: string;
    email: string;
    registeredAt: Date;
  ...
  async getPlayerCharacters(userId: string): Promise<Character[]> {
    try {
  ...
  async getPlayerStatistics(userId: string): Promise<{
    user: {
      id: string;
      username: string;
      email: string;
